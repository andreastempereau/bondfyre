        ...
        <View style={styles.formContainer}>
          ...
          {!isLogin && (
            <>
              ...
              <View style={styles.inputContainer}>
                <MaterialCommunityIcons name="gender-male-female" size={20} color="#666" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
              ...
              <View style={styles.inputContainer}>
                <MaterialCommunityIcons name="information" size={20} color="#666" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
                  placeholder="Bio"
                  value={bio}
              ...
              <View style={styles.inputContainer}>
                <MaterialCommunityIcons name="tag" size={20} color="#666" style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
